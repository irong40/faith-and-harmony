...
import churchTechImage from "@/assets/services/church-tech.png";
    ...
    <div className="min-h-screen bg-background font-sans text-foreground">
      ...
      <div className="max-w-6xl mx-auto px-8">
        ...
        <section className="py-16 text-center">
          <img src={churchTechImage} alt="Church Technology Services" className="w-24 h-24 rounded-2xl object-cover mx-auto mb-6 shadow-lg" />
