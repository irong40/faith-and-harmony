      ...
      <html>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; margin: 0; padding: 0; background-color: #f9fafb;">
          <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
            <div style="background-color: #2b0a3d; padding: 30px; text-align: center; border-radius: 8px 8px 0 0;">
              <h1 style="color: #dfae62; margin: 0; font-size: 24px;">Faith & Harmony LLC</h1>
      ...
      <html>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; margin: 0; padding: 0; background-color: #f9fafb;">
          <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
            <div style="background-color: #2b0a3d; padding: 30px; text-align: center; border-radius: 8px 8px 0 0;">
              <h1 style="color: #dfae62; margin: 0; font-size: 24px;">Faith & Harmony LLC</h1>
              <p style="color: rgba(255,255,255,0.7); margin: 8px 0 0 0; font-size: 14px;">Technology & Creative Services</p>
            </div>
            ...
            <div style="background-color: white; padding: 30px; border-radius: 0 0 8px 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
              ...
              <p style="color: #4b5563; margin-top: 24px;">
                Best regards,<br>
                <strong>The Faith & Harmony Team</strong>
              </p>
            </div>
