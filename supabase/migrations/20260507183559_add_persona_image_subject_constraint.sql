-- Reconstructed 2026-07-13 from remote supabase_migrations.schema_migrations (applied via MCP 2026-05-07).
-- Allow each persona to register a hard rule about who may appear in generated imagery.
-- Injected into image-prompt builders when set; null = no constraint.
